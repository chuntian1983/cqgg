   ...
   public class OfferDAL
    {
       ...
       public void Add(OfferModel model)
       {
           ...
           strSql.Append("Name,Sex,Birthday,Diploma,Specialty,EnglishLevel,School,ID,City,Address,Email,Tel,WantedPay,SelfIntro,Experience,Skill,Polity,BPlace,Mobile,CheckTime,Height,Marry,GraduateTime,CertificateNo,RecordPlace,FamilyState,Request,Approved)");
           ...
           parameters[27].Value = model.Approved;
       ...
       public void Update(OfferModel model)
       {
           ...
           parameters[28].Value = model.Approved;
       ...
       /// 得到一个对象实体
       /// </summary>
       public OfferModel GetModel(int SeekerId)
       {
           StringBuilder strSql = new StringBuilder();
       ...
       //改变审核状态
       public void ApproveSeek(int seekerId, bool isApproved)
       {
           string sql = String.Format("update T_Job_Seeker set Approved={0} where SeekerId={1}", isApproved ? 1 : 0, seekerId);
