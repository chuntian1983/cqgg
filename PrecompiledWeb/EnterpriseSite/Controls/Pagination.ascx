<%@ control language="C#" autoeventwireup="true" inherits="control_Pagination, App_Web_yqweqvkc" %>
<table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" id="__tb_pager" runat="server">
	<tr>
