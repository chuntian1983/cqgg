<%@ control language="C#" autoeventwireup="true" inherits="Controls_Personnel, App_Web_nwnxy2ch" %>
    ...
    <td height="26" background="../images/zp.gif"><table width="91" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td width="32%">&nbsp;</td>
            <td width="40%" class="font4">人事代理</td>
              ...
              <tr>
                <td width="84%" height="26" align="center" valign="top" background="../images/zp1.jpg"><table width="91" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td width="76%"><a href="../Web/Operation.aspx">业务介绍</a></td>
                  </tr>
                </table></td>
              </tr>
              <tr>
                ...
                <tr>
                  <td width="84%" height="26" align="center" valign="top" background="../images/zp1.jpg"><table width="91" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <table width="50%" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td width="24%"><img src="../images/zp3.jpg" width="10" height="10" /></td>
                          <td width="76%"><a href="../Web/OperationList.aspx">业务资料</a></td>
                        </tr>
                      </table></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td width="84%" height="26" align="center" valign="top" background="../images/zp1.jpg"><table width="91" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <table width="50%" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td width="24%"><img src="../images/zp3.jpg" width="10" height="10" /></td>
                          <td width="76%"><a href="../Web/FileSearch.aspx">到档查询</a></td>
                        </tr>
                    </table></td>
                </tr>
                <tr>
