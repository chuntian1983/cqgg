<%@ control language="C#" autoeventwireup="true" inherits="Controls_top, App_Web_szj1oefn" %>
          ...
          <td height="74" valign="top" background="images/dh.jpg"><table width="778" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="14%" height="15" align="center" valign="bottom"><a href="Web/GardenList.aspx?NewsType=3" class="white">运动频道</a></td>
              ...
              <tr>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td width="64%" > <marquee direction="left" scrollamount="1"  width="99%" scrolldelay="3" onmouseover="this.stop()" onmouseout="this.start()">
                  <%=GG %></marquee>    
</td>
                  </tr>
                </table></td>
