<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ExpertOutList.aspx.cs" Inherits="SysAdmin_Worker_ExpertOutList" %>
    ...
    <div>
     <table cellSpacing="0" cellPadding="0" width="800" border="0" align="center">
				...
				<Columns>
                    ...
                    <asp:BoundField DataField="Characteristic" HeaderText="专家特色" />
                    <asp:BoundField DataField="OutTime" HeaderText="出诊时间" />
                    <asp:BoundField DataField="Price" HeaderText="挂号费用" />
				<asp:TemplateField HeaderText="操作">
				<ItemTemplate>
				
				<asp:ImageButton ID="ibtnDel" runat="server" ToolTip="删除"   ImageUrl="../images/ny/del.gif" OnClientClick="javascript:return confirm('你确实要删除吗');" CommandArgument='<%#Eval("Name")%>'  OnCommand="ibtnDel_Command"/>
				</ItemTemplate>
				</asp:TemplateField>
				</Columns>
