<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Leaderlist.aspx.cs" Inherits="SysAdmin_Worker_Leaderlist" %>
    ...
    <div>
     <table cellSpacing="0" cellPadding="0" width="800" border="0" align="center">
				...
				<Columns>
                    ...
                    <asp:BoundField DataField="Area" HeaderText="分管范围" />
                    <asp:BoundField DataField="Science" HeaderText="学术专长" />
				<asp:TemplateField HeaderText="操作">
				<ItemTemplate>
				
				 <asp:HyperLink ID="HyperLink1" runat="server" ImageUrl="../images/ny/edit.gif" NavigateUrl='<%#"LeaderAdd.aspx?WorkerId="+Eval("ID")%>' Text="修改">
                                    </asp:HyperLink>
				...
				&nbsp;<asp:HyperLink ID="HyperLink2" runat="server"  Text="添加领导讲话"   ImageUrl="../images/ny/view.gif"  NavigateUrl ='<%#"LeadSpeakAdd.aspx?WorkerId="+Eval("ID")%>' ></asp:HyperLink>
