...
public partial class SysAdmin_News_CategoryList1 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            p.Demand(157);
            this.imgDel.Visible=this.lbtnDel.Visible=p.HasPermission(159);
            this.imgEdit.Visible=this.lbtnEdit.Visible = p.HasPermission(160);
