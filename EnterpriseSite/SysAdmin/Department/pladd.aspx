<%@ Page Language="C#" AutoEventWireup="true" CodeFile="pladd.aspx.cs" Inherits="SysAdmin_Department_pladd" %>
                                            ...
                                            <table cellspacing="1" cellpadding="5" width="98%"  border="0" align="center">
                                                ...
                                                <tr >
                                                    <td align="right" style="height: 14px">
                                                        <font face="宋体">名称:</font></td>
                                                    <td align="left"  style="height: 14px">
                                                        <font face="宋体" color="#ff0033">
                                                            <asp:TextBox ID="txtTitle" runat="server" Width="200px" BorderStyle="Groove"></asp:TextBox>批量添加中间以|分隔，例如：张三村|李思村<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="* 字段不能为空" ControlToValidate="txtTitle"></asp:RequiredFieldValidator></font></td>
                                                </tr>
