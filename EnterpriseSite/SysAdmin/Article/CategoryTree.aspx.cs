...
public partial class SysAdmin_Article_CategoryList1 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            p.Demand(26);
            this.imgDel.Visible=this.lbtnDel.Visible=p.HasPermission(108);
            this.imgEdit.Visible=this.lbtnEdit.Visible = p.HasPermission(107);
