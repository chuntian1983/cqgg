<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RecordList.aspx.cs" Inherits="SysAdmin_DownLoad_RecordList" %>
    ...
    <div>
     <table cellSpacing="0" cellPadding="0" width="800" border="0" align="center">
				<tr><td style="height: 10px">
                    &nbsp;<strong><span style="color: #0a7ec5">已上传的档案资料：</span></strong></td></tr>
				<tr><td >
				...
				<asp:TemplateField HeaderText="导入数据">
				<ItemTemplate>
				<asp:LinkButton ID="lbtnIntoSQL" runat="server" Text="导入数据" CommandArgument='<%#Eval("FileId")%>'  OnCommand="lbtnIntoSQL_Command"></asp:LinkButton>
				</ItemTemplate>
				</asp:TemplateField>
