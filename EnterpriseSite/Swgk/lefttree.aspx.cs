...
public partial class Swgk_lefttree : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (deptid != null)
            {
                this.treeCategory.Nodes.Add(this._category.GetCategoryTree(deptid));
            }
            else
            {
                this.treeCategory.Nodes.Add(this._category.GetCategoryTree("0"));
            }
