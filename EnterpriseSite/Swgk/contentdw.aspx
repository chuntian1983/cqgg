<%@ Page Language="C#" AutoEventWireup="true" CodeFile="contentdw.aspx.cs" Inherits="Swgk_contentdw" %>
    ...
    <div>
     <table cellSpacing="0" cellPadding="0" width="800" border="0" align="center">
				...
				<tr id="trSearchTop" runat="server">
										<td width="70%" 
                                            style="font-size: x-large; font-weight: bold; text-align: center;">党的基层组织公开监管</td>
				...
				<Columns>
				    <asp:BoundField HeaderText="公开类别" DataField="lbtitle" />
				<asp:BoundField HeaderText="公开信息" DataField="title" />
				</Columns>
