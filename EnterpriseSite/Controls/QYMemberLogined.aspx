<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QYMemberLogined.aspx.cs" Inherits="Controls_QYMemberLogined" %>
...
<body>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="25" colspan="2" align="center" bgcolor="#0472C1"><span class="font4">人才信息查询</span></td>
      </tr>
      <%--<tr>
        <td height="5" colspan="2" align="center"></td>
      </tr>--%>
      <tr>
        <td width="4%" bgcolor="#0472C1">&nbsp;</td>
        <td width="96%"><table width="163" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td height="25" align="center">
                                <SELECT id="selSpec" class="input_2" >
...
<option value='9900' >---其它类---</OPTION> 
            ...
            <tr>
              <td height="25" align="center">
                <select id="selPublicShowDate" class="input_2">
            ...
            </tr><tr><td align="left">关键字：</td></tr>
            <tr>
              <td height="25" align="center"><input id="txtKeyWord" type="text" class="input_1" size="25" /></td>
            </tr>
            <tr>
              <td align="center"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td height="25" align="center">
                        <a href="javascript:void(0);" onclick="searchResult();"><img border="0" height="20" src="../images/ss.jpg" width="66" /></a></td>
                  </tr>
              </table></td>
            </tr>
          </table></td>
