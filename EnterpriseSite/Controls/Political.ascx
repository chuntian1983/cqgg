<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Political.ascx.cs" Inherits="Controls_Political" %>
      ...
      <tr>
        ...
        <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="28%"><a href="../Web/PoliticalList.aspx" class="white">更多...</a></td>
          </tr>
      </table></td>
  </tr>
  <tr>
