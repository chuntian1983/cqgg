<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Work.ascx.cs" Inherits="Controls_Work" %>
    ...
    <td height="26" background="../images/zp.gif"><table width="91" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td width="32%">&nbsp;</td>
            <td width="40%" class="font4">办事指南</td>
            <td width="28%"></td>
          </tr>
      </table></td>
  </tr>
              ...
              <tr>
                <td width="84%" height="26" align="center" valign="top" background="../images/zp1.jpg"><table width="91" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td width="76%"><a href="../Web/WorkFlow.aspx">办事流程</a></td>
                  </tr>
                </table></td>
              </tr>
              <tr>
                ...
                <tr>
                  <td width="84%" height="26" align="center" valign="top" background="../images/zp1.jpg"><table width="91" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <table width="50%" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td width="24%"><img src="../images/zp3.jpg" width="10" height="10" /></td>
                          <td width="76%"><a href="../Web/WorkList.aspx">办理事项</a></td>
                        </tr>
                      </table></td>
                </tr>
                <tr>
