<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StatisticalAnalysis.aspx.cs" Inherits="jubao_StatisticalAnalysis" %>
...
<body>
    ...
    <div style="">
        <div class="table_title"  style=" background-image:url(./images/system1.gif); text-align:center;" >被举报情况表格分析</div>
           <div style=" margin-top:5px;"> <span style="color:Red;">开始时间：</span> <asp:TextBox runat="server" ID="FromTime" onclick="WdatePicker()" class="Wdate"></asp:TextBox> &nbsp; &nbsp; &nbsp; <span style="color:Red;">结束时间：</span> <asp:TextBox runat="server" ID="EndTime" onclick="WdatePicker()" class="Wdate"></asp:TextBox>&nbsp;
                ...
                &nbsp;&nbsp;  
                <asp:Button runat="server" Text="图表分析"  ID="chartLink" 
